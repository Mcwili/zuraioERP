// Prompts & Frameworks Content Translations
// This file contains all content translations for prompts and frameworks
...
export interface PromptsContent {
  promptCategories: {
    ...
    strategy: CategoryData;
    sales: CategoryData;
    service: CategoryData;
    finance: CategoryData;
    hr: CategoryData;
    learning: CategoryData;
    organization: CategoryData;
    coaching: CategoryData;
    promptEngineering: CategoryData;
    quality: CategoryData;
    criticalAnalysis: CategoryData;
  };
  frameworkCategories: {
    mission: CategoryData;
    thinking: CategoryData;
    expression: CategoryData;
    interaction: CategoryData;
  };
}

// German Content
export const promptsContentDE: PromptsContent = {
  promptCategories: {
    market: {
      name: "Markt & Wettbewerb",
      description: "Marktanalyse, Wettbewerbsbeobachtung und Positionierung",
      prompts: [
        {
          title: "Der KI-Rivale",
        ...
        },
        {
          ...
          prompt: "Analysiere mein Geschäftsmodell mit der Denkweise von Reed Hastings, Clayton Christensen und Marc Andreessen. Mein aktuelles Modell sieht folgendermassen aus: [Details zu deinem Geschäftsmodell]. Wo sehen sie Risiken, disruptive Chancen und Hebel für nachhaltiges Wachstum?",
    ...
    planning: {
      ...
      description: "Projektplanung, Roadmaps und Implementierungsstrategien",
      prompts: [
        {
    ...
    strategy: {
      ...
      description: "Geschäftsstrategien, Wachstumsplanung und Innovation",
      prompts: [
        {
    ...
    sales: {
      name: "Vertrieb",
      description: "Prompts für Verkaufsgespräche, Kundenakquise und Verkaufsstrategien",
      prompts: [
        {
    ...
    service: {
      name: "Kundenservice",
      description: "Kundensupport, Kommunikation und Service Excellence",
      prompts: [
        {
    ...
    finance: {
      name: "Finanzen & Reporting",
      description: "Finanzplanung, Controlling und Geschäftsberichte",
      prompts: [
        {
    ...
    hr: {
      ...
      description: "Recruiting, Mitarbeiterentwicklung und HR-Prozesse",
      prompts: [
        {
    ...
    learning: {
      name: "Lernen & Wissen",
      description: "Wissensvermittlung, Training und Dokumentation",
      prompts: [
        {
          title: "Lernarchitekt",
    ...
    organization: {
      ...
      description: "Teamwork, Prozesse und Kollaboration",
      prompts: [
        {
    ...
    coaching: {
      name: "Coaching & Entwicklung",
      description: "Persönliche Entwicklung, Mentoring und Feedback",
      prompts: [
        {
    ...
    promptEngineering: {
      name: "Prompt-Erstellung & Optimierung",
      description: "Effektive AI-Prompts erstellen und verbessern",
      prompts: [
        {
          title: "Megaprompt",
    ...
    quality: {
      name: "Qualitäts- & Ausgabeverbesserung",
      description: "Output-Qualität steigern und verfeinern",
      prompts: [
        {
    ...
    criticalAnalysis: {
      name: "Kritische Analyse & Vorfragen",
      description: "Anforderungen hinterfragen und präzisieren",
      prompts: [
        {
  ...
  frameworkCategories: {
    mission: {
      name: "Mission Frameworks",
      description: "Frameworks zur strukturierten Erstellung von Aufgaben und präzisen Anweisungen",
      frameworks: [
        {
          title: "R-A-I-N",
    ...
    thinking: {
      ...
      description: "Frameworks für klare Gedankenstrukturen und strategisches Denken",
      frameworks: [
        {
          title: "C-L-A-R",
    ...
    expression: {
      name: "Expression Frameworks",
      description: "Frameworks für zielgerichtete Kommunikation und Content-Produktion",
      frameworks: [
        {
          title: "F-L-O-W",
    ...
    interaction: {
      name: "Interaction Frameworks",
      description: "Frameworks für kooperative Kommunikation, Coaching und iterative Prozesse",
      frameworks: [
        {
          title: "C-O-A-C-H",
...
// Export empty structures for now - full translations to be added
export const promptsContentEN: PromptsContent = promptsContentDE; // Placeholder
export const promptsContentFR: PromptsContent = promptsContentDE; // Placeholder
export const promptsContentPTBR: PromptsContent = promptsContentDE; // Placeholder
